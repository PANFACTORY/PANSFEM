//***********************************************************************************************************
//Title		:PANSFEM/InversedAnalysis/Structure/Optimized3PhaseMaterials3D/Optimized3PhaseMaterials3D.cpp
//Author	:Tanabe Yuta
//Date		:2019/10/14
...
#include "Optimized3PhaseMaterials3D.h"


PANSFEM::Optimized3PhaseMaterials3D::Optimized3PhaseMaterials3D() : Equation() {}


PANSFEM::Optimized3PhaseMaterials3D::~Optimized3PhaseMaterials3D() {}


PANSFEM::Optimized3PhaseMaterials3D::Optimized3PhaseMaterials3D(Element * _pelement, std::vector<int> _ulist, std::vector<int> _refulist, std::vector<int> _plist, Integration * _pintegration) : Equation(_pelement, _ulist, _refulist, _plist, _pintegration, 3, 3, 0, 11) {}


void PANSFEM::Optimized3PhaseMaterials3D::SetEquation() {
	//----------パラメータの取得----------
	double s0 = this->pelement->pparameter->parameters[this->peq_to_ps[0]];
	double s1 = this->pelement->pparameter->parameters[this->peq_to_ps[1]];
	double E0 = this->pelement->pparameter->parameters[this->peq_to_ps[2]];
	double V0 = this->pelement->pparameter->parameters[this->peq_to_ps[3]];
	double G0 = this->pelement->pparameter->parameters[this->peq_to_ps[4]];
	double E1 = this->pelement->pparameter->parameters[this->peq_to_ps[5]];
	double V1 = this->pelement->pparameter->parameters[this->peq_to_ps[6]];
	double G1 = this->pelement->pparameter->parameters[this->peq_to_ps[7]];
	double E2 = this->pelement->pparameter->parameters[this->peq_to_ps[8]];
	double V2 = this->pelement->pparameter->parameters[this->peq_to_ps[9]];
	double G2 = this->pelement->pparameter->parameters[this->peq_to_ps[10]];
