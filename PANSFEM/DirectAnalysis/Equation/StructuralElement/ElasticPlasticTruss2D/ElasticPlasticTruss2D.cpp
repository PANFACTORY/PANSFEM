...
void PANSFEM::ElasticPlasticTruss2D::SetEquation(){
	...
	double E = this->pelement->parameters[this->peq_to_ps[1]];			//Þ—¿Young—¦
	double H = this->pelement->parameters[this->peq_to_ps[2]];			//Þ—¿‘Y«ŒW”
	double tauy0 = this->pelement->parameters[this->peq_to_ps[3]];		//‰Šú~•š‰ž—Í
