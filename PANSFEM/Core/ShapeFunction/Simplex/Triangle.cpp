...
Eigen::VectorXd PANSFEM::Triangle::Trial(std::vector<double> _x){
	double x0 = this->pparent->pnodes[0]->u(0), y0 = this->pparent->pnodes[0]->u(1);
	double x1 = this->pparent->pnodes[1]->u(0), y1 = this->pparent->pnodes[1]->u(1);
	double x2 = this->pparent->pnodes[2]->u(0), y2 = this->pparent->pnodes[2]->u(1);
